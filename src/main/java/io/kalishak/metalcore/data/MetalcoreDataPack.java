...
public class MetalcoreDataPack extends DatapackBuiltinEntriesProvider {
    private static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(MetalcoreApiRegistries.METAL_KEY, MetalcoreMetals::bootstrap)
            .add(MetalcoreApiRegistries.ALLOY_KEY, MetalcoreAlloys::bootstrap);

    public MetalcoreDataPack(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, String modId) {
        super(output, registries, BUILDER, Set.of(modId, "minecraft"));
    }
}
