...
public final class MetalcoreBlockEntityType {
    ...
    public static final Supplier<BlockEntityType<PipeBlockEntity>> PIPE = BLOCK_ENTITIES.register("pipe", () -> BlockEntityType.Builder.of(
            PipeBlockEntity::new)
            .build(Util.fetchChoiceType(References.BLOCK_ENTITY, "pipe")));
    public static final Supplier<BlockEntityType<CopperPipeBlockEntity>> COPPER_PIPE = BLOCK_ENTITIES.register("copper_pipe", () -> BlockEntityType.Builder.of(
            CopperPipeBlockEntity::new, MetalcoreBlocks.COPPER_PIPE.get(), MetalcoreBlocks.EXPOSED_COPPER_PIPE.get(), MetalcoreBlocks.WEATHERED_COPPER_PIPE.get(), MetalcoreBlocks.OXIDIZED_COPPER_PIPE.get(),
    ...
    public static final Supplier<BlockEntityType<CopperBellBlockEntity>> COPPER_BELL = BLOCK_ENTITIES.register("copper_bell", () -> BlockEntityType.Builder.of(
            CopperBellBlockEntity::new, MetalcoreBlocks.COPPER_BELL.get(), MetalcoreBlocks.EXPOSED_COPPER_BELL.get(), MetalcoreBlocks.WEATHERED_COPPER_BELL.get(), MetalcoreBlocks.OXIDIZED_COPPER_BELL.get(),
